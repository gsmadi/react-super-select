...
var ReactSuperSelect = function (_React$Component) {
  ...
  _createClass(ReactSuperSelect, [{
    ...
    value: function render() {
      ...
      var RssBase = _react2.default.createClass({
        displayName: 'RssBase',
        ...
        render: function render() {
          return _react2.default.createElement(
            ...
            { ref: function ref(c) {
              ...
              onKeyDown: _this3._handleKeyDown,
              role: 'combobox',
              'aria-activedescendant': _this3._ariaGetActiveDescendentId(),
              'aria-disabled': _this3.props.disabled,
              'aria-haspopup': true,
              'aria-controls': _this3._ariaGetListId(),
              'aria-label': placeholderString,
              'aria-multiselectable': _this3._isMultiSelect(),
              tabIndex: '0' },
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(RssBase, { key: "rss-base-001" }),
        dropdownContent
      );
    }
    ...
    value: function _getNormalDisplayMarkup() {
      ...
      return _lodash2.default.map(this.state.value, function (value, i) {
        var selectedKey = "r_ss_selected_" + value[_this10.state.labelKey];
        if (_this10.props.customSelectedOptionTemplateFunction) {
          if (value.id != null) {
            return _this10.props.customSelectedOptionTemplateFunction(value, i);
          }
        } else if (_this10.props.customOptionTemplateFunction) {
          if (value.id != null) {
            return _this10.props.customOptionTemplateFunction(value, i);
          }
        }
        return _react2.default.createElement(
          'span',
