...
var ReactSuperSelect = function (_React$Component) {
  ...
  function ReactSuperSelect(props) {
    ...
    var _this = _possibleConstructorReturn(this, (ReactSuperSelect.__proto__ || Object.getPrototypeOf(ReactSuperSelect)).call(this, props));
    ...
    _this.ariaRelevantKeydownCodes = _lodash3.default.values(_this.keymap);
    ...
    _this.state = {
      ...
      controlId: _lodash3.default.uniqueId('rss_'),
      ...
      lastOptionId: _lodash3.default.isArray(_this.props.dataSource) && _this.props.dataSource.length > 0 ? _this.props.dataSource.length - 1 : undefined,
  ...
  _createClass(ReactSuperSelect, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.openOnMount) {
        this.setState({
          ...
          if (_this2.props.focusOnMount && !_lodash3.default.isFunction(_this2.props.ajaxDataFetch)) {
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (!_lodash3.default.isEqual(nextProps.initialValue, this.props.initialValue)) {
        newState.value = this._buildInitialValue(nextProps);
      }

      if (!_lodash3.default.isUndefined(nextProps.optionLabelKey) && nextProps.optionLabelKey !== this.props.optionLabelKey) {
        newState.labelKey = nextProps.optionLabelKey;
      }

      if (!_lodash3.default.isUndefined(nextProps.optionValueKey) && nextProps.optionValueKey !== this.props.optionValueKey) {
        newState.valueKey = nextProps.optionValueKey;
      }

      if (!_lodash3.default.isEqual(this.props.dataSource, nextProps.dataSource)) {

        this.lastUserSelectedOption = undefined;

        newState = _lodash3.default.extend(newState, {
          data: this._configureDataSource(nextProps.dataSource),
          rawDataSource: nextProps.dataSource,
          focusedId: undefined,
          lastOptionId: _lodash3.default.isArray(nextProps.dataSource) && nextProps.dataSource.length > 0 ? nextProps.dataSource.length - 1 : undefined
        });
      }

      if (!_lodash3.default.isEmpty(newState)) {
    ...
    value: function render() {
      ...
      if (!_lodash3.default.isEmpty(this.state.value) && this.props.clearable !== false) {
    ...
    value: function toggleDropdown() {
      ...
      if (this.state.isOpen) {
        _lodash3.default.extend(newState, {
          focusedId: undefined
        });
      }
    ...
    value: function _broadcastChange() {
      var outputValue = this._isMultiSelect() ? this.state.value : _lodash3.default.head(this.state.value);
      outputValue = _lodash3.default.isEmpty(outputValue) ? undefined : outputValue;
    ...
    value: function _buildInitialValue(props) {
      ...
      if (!_lodash3.default.isUndefined(props.initialValue)) {
        initialValue = _lodash3.default.isArray(props.initialValue) ? props.initialValue : [props.initialValue];

        if (!this._isMultiSelect()) {
          initialValue = [_lodash3.default.head(initialValue)];
        }
      }
    ...
    value: function _configureDataSource(dataSource) {
      if (_lodash3.default.isArray(dataSource)) {
        return dataSource;
      }

      if (_lodash3.default.isObject(dataSource)) {
        if (_lodash3.default.isArray(dataSource.collection)) {
          return dataSource.collection;
        }

        if (_lodash3.default.isFunction(dataSource.get)) {
          var collection = dataSource.get('collection');
          if (_lodash3.default.isArray(collection)) {
            return collection;
          }
        }
      }
    ...
    value: function _defaultSearchFilter(option) {
      ...
      if (!_lodash3.default.isString(option[this.state.labelKey])) {
        return false;
      }
    ...
    value: function _filterDataBySearchString(data) {
      ...
      if (_lodash3.default.isFunction(this.props.customFilterFunction)) {
      ...
      return _lodash3.default.filter(data, filterFunction);
    }
    ...
    value: function _findArrayOfOptionDataObjectsByValue(value) {
      ...
      var valuesArray = _lodash3.default.isArray(value) ? _lodash3.default.map(value, this.state.valueKey) : [value];
      return _lodash3.default.reject(this.state.data, function (item) {
        return !_lodash3.default.includes(valuesArray, item[_this6.state.valueKey]);
      });
    }
    ...
    value: function _focusDOMOption() {
      var optionRef = this._getFocusedOptionKey();
      if (this._rssDOM[optionRef]) {
        if (_lodash3.default.isFunction(this._rssDOM[optionRef].focus)) {
    ...
    value: function _focusRemovalButtons(event) {
      ...
      if (buttons[nextButtonIndexToFocus]) {
        ...
        this._focusTrigger();
      } else if (buttons[0] && !_lodash3.default.isNumber(currentlyFocusedRemoveButtonIndex)) {
        this._arrestEvent(event);
        buttons[0].focus();
      }
    }
    ...
    value: function _getDataSource() {
      var data = _lodash3.default.isArray(this.state.data) ? this.state.data : [];
      if (_lodash3.default.isString(this.state.searchString)) {
        data = this._filterDataBySearchString(data);
      }

      if (this.props.groupBy) {
        data = _lodash3.default.groupBy(data, this.props.groupBy);
      }
    ...
    value: function _getNormalDisplayMarkup() {
      ...
      return _lodash3.default.map(this.state.value, function (value) {
        var selectedKey = "r_ss_selected_" + value[_this10.state.labelKey];
        if (_this10.props.customSelectedOptionTemplateFunction) {
          if (value.id != null) {
            return _this10.props.customSelectedOptionTemplateFunction(value);
          }
        } else if (_this10.props.customOptionTemplateFunction) {
          if (value.id != null) {
    ...
    value: function _getOptionsMarkup() {
      ...
      if (!_lodash3.default.isArray(data)) {
        _lodash3.default.forIn(data, function (groupedOptions, heading) {
    ...
    value: function _handleKeyDown(event) {
      ...
      if (this.state.isOpen) {
        ...
        if (_lodash3.default.includes(this.ariaRelevantKeydownCodes, event.which)) {
          this._arrestEvent(event);
        }
      }
    ...
    value: function _isCurrentlySelected(dataItem) {
      if (!_lodash3.default.isArray(this.state.value)) {
        return _lodash3.default.isEqual(this.state.value, dataItem);
      }
      return !!_lodash3.default.find(this.state.value, dataItem);
    }
    ...
    value: function _mapDataToOptionsMarkup(data, indexStart) {
      ...
      return _lodash3.default.map(data, function (dataOption, index) {
        ...
        var isCurrentlySelected = _this16._isCurrentlySelected(dataOption),
            ...
            optionMarkup = _lodash3.default.isFunction(_this16.props.customOptionTemplateFunction) ? _this16.props.customOptionTemplateFunction(dataOption, _this16.state.searchString) : dataOption[_this16.state.labelKey],
    ...
    value: function _moveFocusDown() {
      ...
      if (_lodash3.default.isUndefined(this.state.focusedId)) {
        if (this.props.searchable) {
    ...
    value: function _moveFocusUp() {
      ...
      if (!_lodash3.default.isUndefined(this.state.focusedId) && this.state.focusedId !== this.SEARCH_FOCUS_ID) {
        if (this.state.focusedId === 0) {
          if (this.props.searchable) {
    ...
    value: function _needsAjaxFetch() {
      return _lodash3.default.isUndefined(this.state.rawDataSource) && _lodash3.default.isFunction(this.props.ajaxDataFetch);
    }
    ...
    value: function _pageFetchingComplete() {
      if (!_lodash3.default.isFunction(this.props.hasMorePages)) {
        return false;
      }
    ...
    value: function _removeAllOptionsInOptionIdRange(from, to) {
      ...
      var remainingSelected = _lodash3.default.reject(this.state.value, function (opt) {
        return _lodash3.default.includes(valuePropsToReject, opt[_this17.state.valueKey]);
      });
    ...
    value: function _removeSelectedOptionByValue(value) {
      ...
      var callback = arguments.length <= 1 || arguments[1] === undefined ? _lodash3.default.noop : arguments[1];
      ...
      var SelectedAfterRemoval = _lodash3.default.reject(this.state.value, function (option) {
    ...
    value: function _selectAllOptionsInOptionIdRange(from, to) {
      ...
      var optionsToSelect = _lodash3.default.reduce(this.state.data, function (memo, opt) {
        if (_lodash3.default.includes(valuePropsToSelect, opt[_this19.state.valueKey])) {
          memo.push(opt);
        }
        return memo;
      }, []);
    ...
    value: function _selectFocusedOption(eventTargetLi, keepControlOpen) {
      ...
      if (this._rssDOM[focusedOptionKey]) {
        ...
        if (this.SELECTED_OPTION_REGEX.test(this._rssDOM[focusedOptionKey].className)) {
          var optionFullFromValueProp = _lodash3.default.head(this._findArrayOfOptionDataObjectsByValue(optionValue));
    ...
    value: function _setFocusToTagRemovalIfPresent() {
      ...
      var firstValue = _lodash3.default.head(this.state.value)[this.state.valueKey],
          firstTag = this._rssDOM[this._getTagRemoveIndex(firstValue)];

      if (firstTag) {
        if (_lodash3.default.isFunction(firstTag.focus)) {
          firstTag.focus();
          return true;
        }
      }
...
ReactSuperSelect.defaultProps = {
  ...
  onCloseDropdown: _lodash3.default.noop,
  onOpenDropdown: _lodash3.default.noop,
  optionLabelKey: 'name',
